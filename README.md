...
- The previous **Bubblewrap TWA** implementation is archived intact at [`android-twa/`](android-twa/README.md) (same signing keystore, which the standalone app reuses; `versionName 1.25.113` / `versionCode 125113` supersedes the TWA's 1.15.90/11590 with the same applicationId and certificate, so installs upgrade cleanly).

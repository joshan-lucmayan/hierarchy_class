...
export function StoriesRail() {
  ...
  return (
    <>
      ...
      {pickedFile && (
        <div className="mt-3 flex flex-col gap-2 rounded-2xl border border-gold bg-[var(--surface-strong)] p-3 sm:flex-row sm:items-center">
          <input
            value={captionDraft}
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={publishing}
              className="rounded-full bg-gold px-4 py-2 text-xs font-semibold text-navy transition hover:opacity-90 disabled:opacity-50"
            >

      ...
      {status === "sent" ? (
        <div className="flex flex-col items-center gap-4 py-6 text-center">
          ...
          <Link
            replace
            href="/login"
            className="mt-2 flex min-h-[48px] w-full items-center justify-center rounded-xl border border-base bg-surface text-sm font-bold uppercase tracking-widest text-navy transition hover:border-accent-soft active:scale-[0.98] touch-manipulation"
          >
            Back to Log In
          </Link>
        </div>

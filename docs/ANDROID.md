...
> **Package:** `com.hierarchyclass.app` — **TWA build:** `1.15.90` (`versionCode 11590`) — **Web:** `1.16.97` (`package.json:version`; the TWA shell trails the web version and is rebuilt only for native changes)
